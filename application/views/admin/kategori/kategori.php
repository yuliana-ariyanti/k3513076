						...
						<h5>Daftar Kategori Produk.</h5><br />
							<table class="table table-striped table-bordered"><!-- table default style -->
								...
								?>
									...
									<td>
										<button class="btn btn-warning"><a title="Edit Kategori" href="<?php echo base_url(); ?>administrator/edit_kategori_produk/<?php echo $row->id; ?>">
											<i class="icon-edit"></i> Edit</a></button>
										<button class="btn btn-danger"><a href="#" onClick="if(confirm('Anda yakin HAPUS data ini?  Note: Menghapus Kategori mungkin dapat menyebabkan beberapa Produk ikut hilang terhapus, dikarenakan produk mempunyai kategori yang dipilih.')){document.location='<?php echo base_url()?>administrator/hapus_kategori/<?php echo $row->id; ?>'}" title="Hapus Kategori" >
											<i class="icon-trash"></i> Hapus</a></button>
									</td>
								</tr>
							<?php 
								$no++;
