							...
							<table class="table table-striped table-bordered"><!-- table default style -->
								...
								?>
									...
									<td>
										...
										Tampil<br/>
										<button type="button" class="btn btn-success btn-small"><a title="Ubah jadi sembunyi" href="<?php echo base_url(); ?>administrator/edit_status_banner/<?php echo $row->id;?>/<?php echo $row->status; ?>">Ubah jadi sembunyi)</a></button>
										<?php }else{ ?>
										Sembunyi<br/>
											<button type="button" class="btn btn-success btn-small"><a title="Ubah jadi tampil" href="<?php echo base_url(); ?>administrator/edit_status_banner/<?php echo $row->id;?>/<?php echo $row->status; ?>">(Ubah jadi tampil)</a></button>
										<?php } ?>
									</td>
									<td>
										<button type="button" class="btn btn-warning btn-small"><a href="#" onClick="if(confirm('Anda yakin HAPUS data ini? ')){document.location='<?php echo base_url()?>administrator/hapus_banner/<?php echo $row->id; ?>'}" title="Hapus Banner" >
